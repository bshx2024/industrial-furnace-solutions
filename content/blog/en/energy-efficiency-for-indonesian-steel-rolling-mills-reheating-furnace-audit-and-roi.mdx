...
<div className="my-6 p-4 bg-orange-500/5 border-l-4 border-orange-500 rounded-r-lg text-zinc-300 text-sm">
  <strong>Compare with Vietnam:</strong> Vietnamese steel mills face a similar domestic ETS market pilot and strict EU CBAM timelines. Read our analysis: <a href="/blog/vietnam-steel-2026-six-pressures-competitive-advantage" className="text-orange-400 font-bold hover:underline">Vietnam Steel 2026: 6 Survival Pressures & Cost Optimization →</a>
</div>
