...
<div className="my-6 p-4 bg-orange-500/5 border-l-4 border-orange-500 rounded-r-lg text-zinc-300 text-sm space-y-2">
  ...
  <div>
    <strong>Engineering Spec:</strong> Upgrading from pusher to walking beam? Read our comprehensive design guide: <a href="/furnaces/walking-beam-reheating-furnace" className="text-orange-400 font-bold hover:underline">Walking Beam Reheating Furnace Design & Revamping Guide →</a>
  </div>
</div>
