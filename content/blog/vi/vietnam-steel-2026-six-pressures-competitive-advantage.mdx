...
<div className="my-8 p-6 bg-orange-500/10 border border-orange-500/30 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
  <div className="flex-1">
    ...
    <p className="text-zinc-400 text-sm leading-relaxed">
      Bạn không cần ngân sách khổng lồ để giảm chi phí nhiên liệu. Với <strong>Mô hình Quản gia Năng lượng</strong>, chúng tôi lắp đặt tối ưu hóa AI đạt tiêu chuẩn T80 với <strong>chi phí trả trước bằng không</strong>, và chia sẻ dựa trên hiệu quả tiết kiệm nhiên liệu thực tế.
    </p>
  </div>
