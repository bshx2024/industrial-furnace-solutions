    ...
    return (
        <section className="py-20 bg-slate-50 border-t border-slate-100">
            <div className="container mx-auto px-4 md:px-6 text-center">
                <h3 className="text-xl font-heading font-bold text-industrial-800 mb-4 uppercase tracking-widest">
                    Trusted by Industry Leaders
                </h3>
                <p className="text-gray-500 mb-12 font-medium">
                    Deployed in 100+ Mills with a Combined Capacity of &gt;200 Million Tons/Year
                </p>
