                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                            Nationwide pioneering energy steward model for steel rolling reheating processes, jointly developed by <span className="text-industrial-950 font-bold">Jiangsu Nanfang Technology</span> and <span className="text-industrial-950 font-bold">Dongming Green Energy</span> for <span className="text-industrial-950 font-bold">Jinnan Steel Group</span>.
                        </p>
