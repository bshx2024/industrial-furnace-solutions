            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <p className="text-gray-400 text-lg">
                        Deep potential excavation across the entire reheating process, not just single equipment retrofits. We optimize the complete thermal flow.
                    </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 max-w-5xl mx-auto relative px-10">
                    ...
                    <ProcessStep icon={<Layers className="text-furnace-500" size={32} />} label="Soaking Pits (5th Caster)" />
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="p-6 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
                        ...
                        <p className="text-sm text-gray-300">Advanced 5th caster soaking pit energy saving project integration.</p>
                    </div>
                    <div className="p-6 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
