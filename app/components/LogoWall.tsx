            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="max-w-4xl mx-auto text-center mb-16 md:mb-24">
                    ...
                    <p className="text-slate-600 text-lg md:text-xl max-w-2xl mx-auto font-medium leading-relaxed">
                        ...
                        Successfully deployed in <span className="text-slate-900 font-bold">300+ production lines</span> with a combined capacity of <span className="text-slate-900 font-bold border-b-2 border-furnace-500/20 px-1">&gt;200 Million Tons/Year</span>
