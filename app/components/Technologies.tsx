            ...
            <div className="w-full lg:w-1/2 group">
              ...
              <div className="mt-6 flex flex-col items-center gap-2">
                ...
                <span className="text-furnace-500 font-black text-[10px] uppercase tracking-widest animate-pulse cursor-pointer" onClick={() => setIsZoomed(true)}>
                  ...
                  View Official Document & Full Directory  ?                </span>
                                ...
                                <div className="space-y-6">
                                  ...
                                  <div className="space-y-3">
                                    ...
                                    <ul className="text-gray-300 text-sm space-y-2">
                                      ...
                                      <li className="flex gap-2">   <span className="text-white font-bold">&gt;5%</span> Fuel Consumption Saving</li>

                                      <li className="flex gap-2">   <span className="text-white font-bold">+0.1%~0.2% Yield</span> Improvement</li>

                                      <li className="flex gap-2">   <span className="text-white font-bold">&gt;10%</span> Reduction in Oxidation Scale Loss</li>
                                ...
                                <div className="space-y-6">
                                  ...
                                  <div className="space-y-3">
                                    ...
                                    <ul className="text-gray-300 text-sm space-y-2">
                                      ...
                                      <li className="flex gap-2">   <span className="text-white font-bold">+30%</span> Refractory Life Extension</li>
