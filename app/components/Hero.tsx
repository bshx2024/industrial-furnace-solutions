        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center w-full mb-16">
          ...
          <div className="flex-grow max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-white font-medium mb-4 max-w-4xl leading-snug">
              ...
              We invest, you save. Achieve a <span className="text-furnace-500 font-bold">typical 7-15% fuel consumption reduction</span> in your reheating furnaces with our T80-validated extreme efficiency tech paid for entirely by verified energy savings.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mb-12 max-w-4xl">
              ...
              {[
                ...
                "Performance-based 'Energy Steward' model. No CAPEX, paid for by verified savings.",
              ...
              <div className="space-y-6 pt-6 border-t border-white/5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-white/20 uppercase tracking-tight">Estimated Annual Savings</span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-white/20 uppercase tracking-tight">{co2Savings} Carbon Credits Equiv.</span>
