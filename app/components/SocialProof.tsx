        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-6 relative">
            ...
            <div className="bg-white/10 rounded-2xl p-2 aspect-[3/4] border border-white/10 relative overflow-hidden group shadow-2xl">
              ...
              <img src="/t80-doc.png" alt="CISA T80 Verified Technology Catalogue" width={600} height={800} loading="lazy" className="w-full h-full object-cover rounded-xl" />
            </div>
            <div className="bg-white/10 rounded-2xl p-2 aspect-[3/4] border border-white/10 relative overflow-hidden group translate-y-8 shadow-2xl">
              ...
              <img src="/jinnan-site.png" alt="EcoReheating Implementation at Jinnan Steel Site" width={600} height={800} loading="lazy" className="w-full h-full object-cover rounded-xl" />
            </div>
          </div>
        </div>
      </div>
