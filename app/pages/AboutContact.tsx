                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-6">
                                ...
                                Since our strategic technology transfer from <span className="text-industrial-950 font-bold">UK-based FCS in 2014</span>, we have successfully implemented advanced British thermal engineering in <span className="text-industrial-950 font-bold">over 300 production lines</span> globally, achieving comprehensive energy efficiency gains of <span className="text-furnace-600 font-bold">up to 20%</span> (including yield improvements) for major facility retrofits.

                            </p>

                            <p className="text-gray-600 text-lg leading-relaxed mb-8">

                                Guided by the mission of industrial carbon neutrality, we have evolved from a specialized manufacturer into an "Energy Steward" service provider, integrating full-fiber roof technology and AI-supported smart combustion to deliver sustainable industrial value.
                            ...
                            <div className="p-8 bg-industrial-950 text-white rounded-2xl border border-slate-100 mb-8 flex items-center justify-center gap-6 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="text-2xl md:text-3xl font-heading font-black italic text-center relative z-10">
                                    ...
                                    "Mastering Energy. <br className="md:hidden" /> Creating Value."
                            ...
                            <div className="flex gap-8">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 leading-relaxed">
                                        ...
                                        Demonstrated excellence across over 300 production lines globally, setting the benchmark for low-carbon metallurgy and extreme resource utilization.
