...
const CAS_DOSSIER_DATA: Record<string, CaseDossierData> = {
    ...
    "Sichuan Desheng Group": {
        ...
        originalText: ["Original text temporarily removed for build fix"],
    ...
    "Jiangsu Binxin Steel": {
        ...
        translatedText: [
            ...
            "The 260 t/h double-high bar reheating furnace project (cold charging) utilizes intelligent heating control and fiber structure optimization. Post-commissioning gas consumption and oxidation loss metrics rank among the industry's elite."
            ...
            <section className="py-24">
                ...
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <HeroCase
                        ...
                        desc="Implementation of intelligent atmosphere control, achieved domestic leading levels of oxidation loss reduction and yield improvement."
                    ...
                    <HeroCase
                        ...
                        desc="Modernization project reduced gas consumption from 228 m³ /t down to 178.3 m³ /t through systematic thermal optimization."
