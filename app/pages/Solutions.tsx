            ...
            <section className="pt-40 pb-20 bg-industrial-950 text-white">
                ...
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <p className="text-xl text-gray-400 max-w-3xl leading-relaxed">
                        ...
                        Integrated energy-saving solutions for reheating furnaces and soaking pits in steel rolling mills, built around the Energy Steward Model pioneered with Jinnan Steel.
                            ...
                            <tbody className="divide-y divide-slate-100">
                                ...
                                <tr>
                                    ...
                                    <td className="p-6 align-top">
                                        ...
                                        <div className="flex items-center gap-3 font-bold text-industrial-900 mb-2">
                                            ...
                                            <AlertTriangle size={16} className="text-red-500" /> High oxidation loss
                                ...
                                <tr>
                                    ...
                                    <td className="p-6 align-top">
                                        ...
                                        <p className="text-[10px] leading-tight text-gray-500 italic">Full-fiber roof and non-ceramic functional coatings are designed to reduce lining wear and unplanned shutdowns; actual intervals depend on your operational profile.</p>
